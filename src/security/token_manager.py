...
class JWTAuthManager(JWTAuthManagerInterface):
    """
    A manager for creating, decoding,
    and verifying JWT access and refresh tokens.
    """
    ...
    def __init__(
        ...
        """
        Initialize the manager with secret keys
        and algorithm for token operations.
        """
